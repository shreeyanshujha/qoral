...
const cases = [
  ...
  ['exited wrapper', '\n[agora] agent "ada" exited (0). Press Enter to close this window.', 'exited'],
  ['documenting wrapper', '\n[agora] documenting session… (writes .agora/notes)', 'documenting'],
  ['empty screen', '\n\n', 'starting'],
